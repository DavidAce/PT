...
//using namespace std;
//
//void class_model_old::randomize_lattice() {
//    for(int i = 0; i < L ; i++){
//        for(int j= 0; j < L ; j++){
...
//std::ostream &operator<<(std::ostream &os, const class_model_old &model){
